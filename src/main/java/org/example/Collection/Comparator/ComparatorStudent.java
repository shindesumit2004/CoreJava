...
class StudentDetails{
    ...
    public StudentDetails(int id, int rollNum, String fName, String IName, double salary){
        this.id = id;
...
class FName implements Comparator<StudentDetails>{
...
class RollNo implements Comparator<StudentDetails>{
